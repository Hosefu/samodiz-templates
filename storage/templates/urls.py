...
from .views import TemplateViewSet, pages_list_create, page_detail, upload_template_file, serve_template_file, health_check
from .asset_views import upload_page_asset, delete_page_asset
...
urlpatterns = [
    ...
    # Обновленные эндпоинты для ассетов
