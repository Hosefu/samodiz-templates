...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='template',
            name='owner',
            field=models.ForeignKey(help_text='Владелец шаблона', on_delete=django.db.models.deletion.CASCADE, related_name='legacy_owner_templates', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='template',
            name='unit',
